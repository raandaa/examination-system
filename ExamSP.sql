...
create proc AddExam @id int , @dur int , @date date ,
@marks int , @crsid int , @stdid int , @score int
as
	insert into Exam values(@id , @dur , @date , @marks , @crsid , @stdid , @score)
...
EXEC ExamGeneration 2, 2, 1, 1;
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
GO
CREATE PROCEDURE QuestionAnswer
	@examID int, @studID int, @questionId int, @answerId int 
AS
BEGIN
    -- Insert answers 
